package com.thinkit.cloud.jenkinsci.vo;
...
public class JobInformationVO {
    ...
    public JobInformationVO(String name, String displayName, String fullDisplayName, String url, List<BuildVO> builds, List<healthReport> healthReport, BuildVO lastBuild, BuildVO lastFailedBuild, BuildVO lastSuccessfulBuild, BuildVO lastStableBuild, String description, boolean buildable) {
        this.name = name;

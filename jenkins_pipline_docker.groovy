        ...
        if(params.IS_RUN_SONAR) {    
			dir("${WORKSPACE}"){
				try{
					...
					sh "echo 'sonar.projectKey=param.MODEL_NAMES:params.GIT_BRANCH' >> sonar-project.properties"
					sh "echo 'sonar.projectName=param.MODEL_NAMES:params.GIT_BRANCH' >> sonar-project.properties"
